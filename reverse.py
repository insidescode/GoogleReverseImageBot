...
def reverse_image(message):
    if message.reply_to_message.content_type == 'photo':
        ...
        bot.send_message(message.chat.id, "Reverse Image Search Completed!!! Click the Search Results button to view results.",reply_markup=types.InlineKeyboardMarkup([ [types.InlineKeyboardButton(text='Search Results', url=reverse_final_url)], [types.InlineKeyboardButton(text='Kronos Support', url='https://t.me/KeevChat')]]))
